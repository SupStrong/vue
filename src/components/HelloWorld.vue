...
<el-container style="height: 500px; border: 1px solid #eee">
  <el-aside width="200px" class="menus-aside" style="background-color: rgb(238, 241, 246)">
    <el-menu :default-openeds="['1', '3']">
      <el-submenu index="1">
        <template slot="title"><i class="el-icon-message"></i>导航一</template>
        <el-menu-item-group>
          <template slot="title"><a href="/one">111</a></template>
...
<style>
  ...
  .menus-aside::-webkit-scrollbar { width: 12px;}/* 滚动槽 */
